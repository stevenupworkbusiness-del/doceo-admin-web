...
const TagCreateModal: React.FC<Props> = ({ onAdded, showModal, onHideModal }) => {
	...
	const onSubmit = async (data: { name: String, category: String }) => {
		try {
			const res = await API.graphql<GraphQLQuery<CreateTagMutation>>({
				query: createTag,
				variables: {
					input: {
						name: data.name,
				...
				<div className="modal-dialog modal-dialog-center">
					<div className="modal-content">
						<div className="modal-header">
							<h6 className="modal-title">Create Tag</h6>
