...
import { CreateCategoryMutation } from '@/types';
...
const CategoryCreateModal: React.FC<Props> = ({ onAdded, showModal, onHideModal }) => {
	...
	const onSubmit = async (data: { name: String, description: String }) => {
		...
		try {
			...
			onAdded(res.data?.createCategory);
		} catch (e) {
			console.error(e);
		}
	}
				...
				<div className="modal-dialog modal-dialog-center">
					<div className="modal-content">
						<div className="modal-header">
							<h6 className="modal-title">Create Category</h6>
