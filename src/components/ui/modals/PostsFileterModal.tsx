...
const PostsFilterModal: React.FC<Props> = ({ onHideModal }) => {
						...
						<div className="modal-body  text-muted leading-relaxed">
							<div className='mb-2.5'>
								...
								<div>
									<button
										type="button"
										onClick={() => toggleFilter('verb', '')}
										className={`text-sm font-medium  px-3 py-2 mr-2  mb-2 rounded ${isFilterActive('verb', '') ? 'text-white bg-blue-500 hover:bg-blue-600 focus:ring-4 focus:ring-blue-300 dark:bg-blue-500 dark:hover:bg-blue-600 focus:outline-none dark:focus:ring-blue-700' : 'text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700'}`}
									>All</button>
									<button
										type="button"
										onClick={() => toggleFilter('verb', 'tweet')}
										className={`text-sm font-medium  px-3 py-2 mr-2  mb-2 rounded ${isFilterActive('verb', 'tweet') ? 'text-white bg-blue-500 hover:bg-blue-600 focus:ring-4 focus:ring-blue-300 dark:bg-blue-500 dark:hover:bg-blue-600 focus:outline-none dark:focus:ring-blue-700' : 'text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700'}`}
									>Tweet</button>
									<button
										type="button"
										onClick={() => toggleFilter('verb', 'diary')}
										className={`text-sm font-medium  px-3 py-2 mr-2  mb-2 rounded ${isFilterActive('verb', 'diary') ? 'text-white bg-blue-500 hover:bg-blue-600 focus:ring-4 focus:ring-blue-300 dark:bg-blue-500 dark:hover:bg-blue-600 focus:outline-none dark:focus:ring-blue-700' : 'text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700'}`}
