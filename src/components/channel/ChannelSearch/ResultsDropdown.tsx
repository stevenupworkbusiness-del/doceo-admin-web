...
const SearchResult: React.FC<SearchResultProps> = (props) => {
	...
	if (isChannel(result)) {
		const channel = result as Channel<TeamChatGenerics>;
		...
		const user = result as UserResponse<TeamChatGenerics>;
...
type ResultsDropdownProps = {
  teamChannels?: Channel<TeamChatGenerics>[];
  directChannels?: UserResponse<TeamChatGenerics>[];
  focusedId: string;
  loading: boolean;
  setChannel: (
    channel: Channel<TeamChatGenerics>,
  ) => void;
	...
	return (
		<div className='channel-search__results'>
			...
			{!loading && !directChannels?.length ? (
				...
				directChannels?.map((user: UserResponse<TeamChatGenerics>, i) => (
